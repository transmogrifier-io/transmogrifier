...
const filters =
{
    ...
    oden_to_transmogrifier: async function (data, params) {
        return odenToTransmog(data, params);
    }
};
...
function odenToTransmog(data, params) {
    ...
    return JSON.stringify(output_obj, null, 2);
